...
class Functions {
    ...
    // This Function Return LastUser Added 

            public function getLastestUser()
            {
                // Return Last User Add With It ID 

                $lastest = DB::table('users')->orderBy('created_at','DESC')->first();
                //$lastest = dd($lastest);
                return $lastest->id;
            }

            // this function Upate The Member Code Once He Registered 

            public function updateMemberCode($lastUser,$uniqe)
            {
                DB::table('users')
                ->where('id', $lastUser)
                ->update(['member_code' => $uniqe]);

            }
// Array To Execute All Contries Names 
